...
citation_url: https://blog.djnavarro.net/welcome
...
- **Simplicity**. One mistake I've often made is to create blogs using the fanciest tools I could find. For example, I've previously used Hugo based packages like blogdown and hugodown, and much as I love those tools (and use them on other sites) I want this blog to be as low-maintenance as possible. To that end I'm using [distill for R markdown](https://rstudio.github.io/distill/), and I'm keeping the default settings in most respects.
