...
refinery::renv_load(params$slug)
```
...
```{r}
refinery::record_timestamp("Australia/Sydney")
```

## Details {.appendix}

```{r}
refinery::record_source("djnavarro/distill-blog", params$slug)
htmltools::span(", ")
refinery::record_lockfile("djnavarro/distill-blog", params$slug)
```
