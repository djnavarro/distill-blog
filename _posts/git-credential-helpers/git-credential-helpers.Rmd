...
This is a perfectly functional solution to the problem, and is currently the advice that [Happy Git and GitHub for the useR](https://happygitwithr.com/credential-caching.html#linux-1) suggests for linux users. Importantly, they are at pains to point out that *they* took this advice from the [GitHub documentation](https://docs.github.com/en/get-started/getting-started-with-git/caching-your-github-credentials-in-git), and that it is generally wise to regard the GitHub documentation as the authoritative source on how to cache yout GitHub credentials!
...
If it's working properly you should see this:
...
In a happier world you would be done at this point, but we don't live in a happy world. We live in a terrible world that has global pandemics and pineapple on pizzas. So there's still one job left to do.
