...
citation_url: https://blog.djnavarro.net/serialisation-with-rds
...
<p align="right">
*Oh you sweet summer child. You really think you are prepared to walk into the dark? That's adorable.*
</p>
...
<p align="right">
*You can sense it can't you? It will only get worse for you, my sweet. Look upon the grim visage of those that have passed this way before. Their lifeless skulls are a warning, but you in your hubris think you will survive?*
</p>
...
<p align="right">
*Clever girl. Yes, the default behaviour is binary serialization. Unless otherwise specified using the `xdr` argument, `serialize()` enforces a big-endian representation on the binary encoding. But you didn't want to go there did you? It frightened you, didn't it? The abyss stares back at you, sweetness, and you are beginning to notice its attention*
</p>
...
<p align="right">
*Wilting already, aren't you? Poor little flower. You've already been cut from the stem. You're dead already but you don't even know it. All that is left is to wither away under the blistering glare of knowledge.*
</p>
...
Now that I have a sense of how the RDS header works, I'll set `header = FALSE` whenever I call `show_rds()` from now on. That way I won't have to look at that same six lines of output over and over.

<p align="right">
*Oh no my dear. Hiding from it won't save you.*
</p>
...
```{r}
#| echo = FALSE,
#| fig.cap = "Image by Atharva Lele. Available by CC0 licence on [unsplash](https://unsplash.com/photos/GSXHEh-5IMI)."
knitr::include_graphics("img/atharva-lele-GSXHEh-5IMI-unsplash.jpg")
```
