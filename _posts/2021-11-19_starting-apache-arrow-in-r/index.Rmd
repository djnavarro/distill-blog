...
Let's start at the beginning, with the most important question of all: do you actually need to care about this? This might be a long post, so let's make sure you're reading it for the right reasons!
...
### Example 1: the data aren't stored in R memory
