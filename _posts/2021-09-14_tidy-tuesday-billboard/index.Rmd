...
<aside>In the R community, "laptop fires" are universally understood to be a reference to what happens to you when you foolishly ignore the wise advice of Jenny Bryan</aside>
...
<aside>At this point I was sorely tempted to get distracted by Ke$ha and Rihanna, but somehow managed to stay on topic. Somehow</aside>
...
<aside>In my mental list of "stuff I hatelove in data science", git and regexes are tied for first place</aside>
...
<aside>I should make a confession here. I didn't technically need to use a regex here. The stringr package also has a handy `str_starts()` function which I could have used. But half the point of our slack group is to accidentally-on-purpose reveal new tools so... regex it is</aside>
