...
**Aside**: There's an R script containing the source code for this analysis [here](https://github.com/djnavarro/distill-blog/blob/master/_posts/2021-09-14_tidy-tuesday-billboard/britney.R), and an R markdown version that mirrors this post almost exactly [here](https://github.com/djnavarro/distill-blog/blob/master/_posts/2021-09-14_tidy-tuesday-billboard/britney.Rmd)
...
**Aside**: In the R community, "laptop fires" are universally understood to be a reference to what happens to you when you foolishly ignore the wise advice of Jenny Bryan 
...
**Aside**: [R for data science](https://r4ds.had.co.nz/) is a wonderful book by Hadley Wickham and Garrett Grolemund 
...
**Aside**: Readme files are your best friend. Seriously 
...
**Aside**: I didn't intend for this section to be this long, honest 
...
**Aside**: At this point I was sorely tempted to get distracted by Ke$ha and Rihanna, but somehow managed to stay on topic. Somehow 
...
**Aside**: In my mental list of "stuff I hatelove in data science", git and regexes are tied for first place 
...
**Aside**: A confession. I didn't technically need to use a regex here, because stringr has a handy `str_starts()` function. But half the point of our slack group is to accidentally-on-purpose reveal new tools and also I forgot that `str_starts()` exists so... regex it is 
