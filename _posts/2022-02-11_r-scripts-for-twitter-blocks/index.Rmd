---
title: "R scripts for twitter mutes and blocks" # <---- UPDATE ME
description:
...
But if you follow me along this path you need to be aware of the risk too... don't go off-label lightly! In my case I didn't do this on a whim: I chose this path about a year ago out of personal desperation (see later), and I've had to rewrite the scripts a lot in that time. So, please be careful.
...
Be warned though, due to the twitter API rate limites, the muting process is slow. 
