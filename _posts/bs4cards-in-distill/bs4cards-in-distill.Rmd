...
If, like me, you only want to enable strapless for a specific post, this goes in the YAML header for that post only. Alternatively, if you want to enable it for the entire site, this markup goes in the `_site.yml` file.
