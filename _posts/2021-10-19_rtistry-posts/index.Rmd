...
- [Thinking outside the grid: A "bare bones" intro to Rtistry concepts in R using ggplot](https://www.thetidytrekker.com/post/thinking-outside-the-grid) by [Meghan Harris](https://twitter.com/meghansharris)
