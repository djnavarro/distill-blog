...
Of course it can't. That's *not* the task at hand. Your CV bears no relationship to your value as a person, and its *only* function is to convince the right company to give you an interview. Notice that I say "the right company". That's important and I'm going to come back to that!

Yes fine, Danielle, I hear you say. But how do I do this? It's a big conceptual shift and I don't even know where to start the process. Worry not, beloved reader, for just this once^[It won't happen again, I promise!] I have practical guidance for you. No really, I do. It's very practical, so you can stop laughing now. 
...
Once I'd finally gotten to that point, and was comfortable viewing the whole job search process this way, it became a lot easier for me to accept that a résumé is not in any way a meaningful representation of my skills, my history, or my ability. It is simply an **advertisement that follows a predictable format**. So for step 3, I discarded all my pretty words and wrote an [industry-style résumé](resume/danielle-navarro-industry-resume.pdf).^[An industry résumé is really only supposed to be one page long, and you can see that I'm *still* clinging a little to my academic past by making mine two pages, but at least this verion really is an industry style format. This résumé is made using the pagedown package, and it strongly assumes you're only doing a one-page format. If you want to see how badly I had to hack into it in order to focre a two-page output, you can look at my [R markdown source](resume/danielle-navarro-industry-resume.Rmd) if you like. Be warned, it is grim!] As you can see, this is a quite different style of document. It's written almost entirely as dot point lists, it focuses as much on skills as on accomplishments, and there is a lot of white space. Generally, that's what you want.


### ...and it you should advertise you as you want to be

One more tiny thing to mention about the résumé before I move on. I've forgotten where I heard this (it's definitely not an original thought of mine) but because the résumé is the first point of contact with the company in many cases, it's also an exercise in expectation management. You are implicitly telling a story in this résumé about a particular type of person, and if you get an interview then people will expect that person in the interview. If you get the job from that interview, then they'll expect the person from the interview to show up on the job. 

So, who do you want to be in your new job? Maybe you don't want to be the same person you've been all your academic life. If so, it's totally fine to deemphasise skils and accomplishments that relate to *that person*, but aren't representative of who you want to be in your new role. You're allowed to reinvent yourself a little bit in your résumé. It's part of the healing process! 


## More like Grindr than Bridgerton
...
What I do know is that I started the "initial conversation" with 11 different companies during my job search. The initial conversation is itself an informal interview (usually with a recruiter) and it goes both ways. You may or may not go to the "real" interview stage after that: for me, I reached the interview stage with 5 of the 11 companies I'd started conversations with. The interview process was different at every company, but most of them weren't a single interview but rather a series of interviews with different people. Sometimes there were "skills tests" to take (seriously, this is a thing), other times there were not. It was quite different to what I expected from academia, and it took a few failed attempts before I worked out the basics of how to interview. 

Eventually I ended up with offers from two different companies, I negotiated briefly,^[Any decent guide to a job search will talk to you about how to negotiate and what ought to be negotiated in your kind of job search. But this is not a decent guide and I am really not the person you should rely upon for advice.] and then chose to accept the offer from Voltron Data.
