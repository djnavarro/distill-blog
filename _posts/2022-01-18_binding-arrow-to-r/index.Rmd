...
Real life, however, is filled with [leaky abstractions](https://www.joelonsoftware.com/2002/11/11/the-law-of-leaky-abstractions/), and the **arrow** package is no exception. The current version of the package (v6.0.1) doesn't mirror all the functionality of **dplyr** and the support for other tidyverse packages like **lubridate** and **stringr** is very much a work in progress!
...
Okay, so let's dig a little deeper. 
