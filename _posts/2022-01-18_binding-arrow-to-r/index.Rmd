...
<aside>Throughout this post I'll use boldface to refer to specific R packages like **dplyr** or C++ libraries like **libarrow**. In a slight abuse of notation, I'll also use **arrowplyr** to refer to the combination of **arrow** and **dplyr**</aside>
...
The nice thing for R users is that all of this feels like regular R code. Although **libarrow** is doing all the serious computation -- none of the real work is being done within R -- but the user really doesn't need to worry too much about that. The **arrowplyr** toolkit works seamlessly and invisibly.
...
<aside>At this point in the show *everybody* except currently-amnesic main characters knows that Marina has no interest in helping anyone except Marina. I love Marina so much</aside>
...
#| echo = FALSE,
#| fig.align = "center",
#| fig.cap = "Okay fine, there's no connection between slightly-evil-Julia burning down the talking trees and my slightly-evil digression. I just love this scene and secretly wish I was her. Of all the characters Julia has the most personally transformative arc (in my opinion), in both good ways and bad. There's a lot going on with her life, her person, and her body. I relate to that. Image via [giphy](https://giphy.com/gifs/syfy-l0IydgNESZjrALWqA), copyright [syfy](https://www.syfy.com)"
...
The `arrow_start_date` and `arrow_today` variables are now pointers to data structures in Arrow, and are suitable for passing to the **libarrow** `days_between()` function:
...
#| echo = FALSE,
#| fig.align = "center",
#| fig.cap = "Okay look, I'll level with you. There is absolutely no connection between this gif and Arrow Expressions. This post is getting very long and I don't know about you but I need a short break to appreciate the beautiful people. Image via [giphy](https://media.giphy.com/media/xUA7aOXC4Lrm8p2Ofm/giphy.gif), copyright [syfy](https://www.syfy.com)"
