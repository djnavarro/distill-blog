...
A natural solution to this is to design floating point data types that use other bases. Arrow, like Python, includes  [decimal floating point](https://en.wikipedia.org/wiki/Decimal_floating_point) types that are essentially equivalent to the more familiar binary floating point numbers, but they rely on a base 10 decomposition:
