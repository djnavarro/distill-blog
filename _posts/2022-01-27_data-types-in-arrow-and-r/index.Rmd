...
```{r, include=FALSE}
# ????????
#conflicted::conflict_prefer("duration", "arrow")
...
Any discussion of temporal data is incomplete without a discussion of duration types, which are used to describe a length of time without reference to any fixed origin. 
...
```{r}
browser()
#Scalar$create(rmd_time, type = duration())
```
