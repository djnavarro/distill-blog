...
It's a little tricky for me to write about the decimal type directly because R doesn't have any analog of a decimal, so I can't import an "R decimal object" to Arrow. However, what I can do is take the Arrow float64 objects I defined earlier and explicitly cast them to decimal format:

```{r}
decimal_01 <- float_01$cast(decimal(5, 5))
decimal_01
decimal_01$type
```

```{r}
decimal_02 <- float_02$cast(decimal(5, 5))
decimal_03 <- float_03$cast(decimal(5, 5))
