...
There are three things you can do immediately without any major hassle. First, if you click on "choose file" you can upload an image to give yourself a profile image. Second, you can give yourself a username. The advice I read on the relevant [HEN wiki page](https://github.com/hicetnunc2000/hicetnunc/wiki/Edit-your-profile) suggested that you should avoid spaces and special characters, and should stick to lower case letters because usernames are case sensitive (which surprised me). Third, you can write a brief description of yourself.  

Once you've done those three things, click on "save profile". Ignore everything below the "save profile" button. All that stuff is useful, and it will let you do things like link to your twitter profile and your github profile, but it's surprisingly finicky to set up and it costs money, so we'll leave that until later.


### More information?

For more information about editing your profile, you can check out the HEN .
